...
public class BookService {
	...
	// 도서클릭하여 내 장바구니에 넣기
	//  출력한 도서의 bookid 값 받아야 되고, 현재 로그인한 회원 id(번호)가 필요
	...
	public void loanSave(int id, int bookId, String email) {
		...
		//Service에서 controller로부터 받은 일을 한다.
		//근데 db가 필요하니까 repository 불러서 db 처리해달라고 요청
	...
	public void returnEx(int id) {
		bookRepository.returnExecuteDB(id);
	}
